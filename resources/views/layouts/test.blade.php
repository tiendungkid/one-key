...
<head>
    ...
    <title>One Key Managet @yield('title', '- Home')</title>
    <!-- Favicon -->
    <link rel="icon" href="{{asset('vendors/profile/assets/img/brand/favicon.png')}}" type="image/png">
    <!-- Fonts -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700">
    <!-- Icons -->
    <link rel="stylesheet" href="{{asset('vendors/profile//assets/vendor/nucleo/css/nucleo.css')}}" type="text/css">
    <link rel="stylesheet"
          href="{{asset('vendors/profile/assets/vendor/@fortawesome/fontawesome-free/css/all.min.css')}}"
          type="text/css">
    <!-- Page plugins -->
    <!-- Argon CSS -->
    <link rel="stylesheet" href="{{asset('vendors/profile/assets/css/argon.css?v=1.2.0')}}" type="text/css">
</head>
...
<nav id="navbar-main" class="navbar navbar-horizontal navbar-main navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
        <a class="navbar-brand" href="#">
            <img src="{{asset('vendors/profile/assets/img/brand/white.png')}}" alt="demo">
        </a>
            ...
            <div class="navbar-collapse-header">
                <div class="row">
                    <div class="col-6 collapse-brand">
                        <a href="#">
                            <img src="{{asset('vendors/profile/assets/img/brand/blue.png')}}" alt="demo">
                        </a>
                    </div>
...
<div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="pr-5">
                            ...
                            <div class="mt-5">
                                <a href="#" class="btn btn-neutral my-2">Explore
                                    Dashboard</a>
                            ...
                            <div class="card card-lift--hover shadow border-0">
                                <div class="card-body py-5">
                                    ...
                                    <p class="description mt-3">Argon makes customization easier than ever before. You
                                        get all the tools to make your website building process a breeze.</p>
                                    <div>
        ...
        <div class="container">
            <div class="row row-grid align-items-center">
                <div class="col-md-6 order-md-2">
                    <img src="{{asset('vendors/profile/assets/img/theme/landing-1.png')}}" class="img-fluid" alt="demo">
                </div>
                <div class="col-md-6 order-md-1">
                    <div class="pr-md-5">
                        <h1>Awesome features</h1>
                        <p>This dashboard comes with super cool features that are meant to help in the process.
                            Handcrafted components, page examples and functional widgets are just a few things you will
                            see and love at first sight.</p>
    ...
    <section class="py-6">
        <div class="container">
            <div class="row row-grid align-items-center">
                <div class="col-md-6">
                    <img src="{{asset('vendors/profile/assets/img/theme/landing-2.png')}}" class="img-fluid" alt="demo">
                </div>
                <div class="col-md-6">
                    <div class="pr-md-5">
                        <h1>Example pages</h1>
                        <p>If you want to get inspiration or just show something directly to your clients, you can jump
                            start your development with our pre-built example pages.</p>
                        <a href="#" class="font-weight-bold text-warning mt-5">Explore
                            pages</a>
                    </div>
                </div>
            </div>
    ...
    <section class="py-6">
        <div class="container">
            <div class="row row-grid align-items-center">
                <div class="col-md-6 order-md-2">
                    <img src="{{asset('vendors/profile/assets/img/theme/landing-3.png')}}" class="img-fluid" alt="demo">
                </div>
                <div class="col-md-6 order-md-1">
                    <div class="pr-md-5">
                        ...
                        <p>We love cards and everybody on the web seems to. We have gone above and beyond with options
                            for you to organise your information. From cards designed for content, to pricing cards or
                            user profiles, you will have many options to choose from.</p>
            ...
            <div class="row row-grid justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="display-3">Do you love this awesome <span
                            class="text-success">Dashboard for Bootstrap 4?</span></h2>
                    <p class="lead">Cause if you do, it can be yours now. Hit the button below to navigate to get the
                        free version or purchase a license for your next project. Build a new web app or give an old
                                ...
                                <a href="https://www.creative-tim.com/product/argon-dashboard" target="_blank"
                                   ...
                                   data-original-title="Bootstrap 4 - Most popular front-end component library">
                                    <img
                                        ...
                                        class="img-fluid rounded-circle shadow shadow-lg--hover" alt="demo">
                                </a>
                            </div>
                            <div class="col-md-2 col-3 my-2">
                                ...
                                <a href=" https://www.adobe.com/products/photoshop.html" target="_blank"
                                   ...
                                   data-original-title="[Coming Soon] Adobe Photoshop - Software for digital images manipulation">
                                    <img
                                        ...
                                        class="img-fluid rounded-circle opacity-3" alt="demo">
                                </a>
                            </div>
                        </div>
                    </div>
...
<!-- Optional JS -->
<script src="{{asset('vendors/profile/assets/vendor/onscreen/dist/on-screen.umd.min.js')}}"></script>
<!-- Argon JS -->
<script src="{{asset('vendors/profile/assets/js/argon.js?v=1.2.0')}}"></script>
<!-- Demo JS - remove this in your project -->
<script src="{{asset('vendors/profile/assets/js/demo.min.js')}}"></script>
</body>
</html>
